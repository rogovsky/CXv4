...
enum
{
    ...
    CDA_CONTEXT_OPT_NO_OTHEROP = 1 << 0,
    CDA_CONTEXT_OPT_IGN_UPDATE = 1 << 1,
};
...
enum
{
    ...
    CDA_DATAREF_OPT_FIND_ONLY  = 1 << 28,
    CDA_DATAREF_OPT_ON_UPDATE  = 1 << 27,
...
enum
{
    ...
    CDA_OPT_HAS_PARAM  = 1 << 2,
    CDA_OPT_RETVAL_RQD = 1 << 3,
