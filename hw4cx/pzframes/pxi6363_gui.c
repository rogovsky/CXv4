...
static Widget pxi6363_mkctls(pzframe_gui_t           *gui,
                             ...
                             pzframe_gui_mkparknob_t  mkparknob)
{
  ...
  char    spec[1000];
    ...
    snprintf(spec, sizeof(spec),
             ...
             1, PXI6363_MAX_NUMPTS, 1, PXI6363_MAX_NUMPTS);
    w1 = mkparknob(gui, ptsform, spec, PXI6363_CHAN_NUMPTS);
    //---- no PTSOFS //

    /* 3. Per-channel parameters and repers */
    for (nl = 0;  nl < PXI6363_NUM_LINES;  nl++)
    {
...
pzframe_gui_dscr_t *pxi6363_get_gui_dscr(void)
{
  ...
  static int                 dscr_inited;
    ...
    if (!dscr_inited)
    {
        FastadcGuiFillStdDscr(&dscr,
                              pzframe2fastadc_type_dscr(pxi6363_get_type_dscr()));
