...
enum
{
    ...
    FROLOV_IE4_CHAN_DIAG_n_base = 70, FROLOV_IE4_CHAN_DIAG_n_count = 6,
    FROLOV_IE4_CHAN_DIAG_Rf    = FROLOV_IE4_CHAN_DIAG_n_base + 0,
    FROLOV_IE4_CHAN_DIAG_Rm    = FROLOV_IE4_CHAN_DIAG_n_base + 1,
    FROLOV_IE4_CHAN_DIAG_RKm   = FROLOV_IE4_CHAN_DIAG_n_base + 2,
    FROLOV_IE4_CHAN_DIAG_RKp   = FROLOV_IE4_CHAN_DIAG_n_base + 3,
    FROLOV_IE4_CHAN_DIAG_RKd   = FROLOV_IE4_CHAN_DIAG_n_base + 4,
    FROLOV_IE4_CHAN_DIAG_Rs    = FROLOV_IE4_CHAN_DIAG_n_base + 5,
